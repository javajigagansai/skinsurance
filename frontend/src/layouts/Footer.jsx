          ...
          <div className="lg:col-span-5 flex flex-col justify-start items-start gap-4">
            <Link to="/" className="inline-flex items-center gap-3.5 group">
              ...
              <div className="flex flex-col text-left justify-center leading-none">
                <svg viewBox="0 0 240 28" className="h-9 sm:h-10 md:h-11 w-auto max-w-[260px] select-none" aria-label="SK Smart Investments - Insurance and Investments Specialist">
                  <text 
                    x="0" 
                    y="13" 
            ...
            <div className="w-full max-w-[295px] flex items-center justify-between pt-1 translate-x-3 sm:translate-x-4">
              {[
                ...
                <a
                  ...
                  className={`w-10 h-10 rounded-xl border flex items-center justify-center transition-all duration-300 ${item.color} shadow-sm hover:scale-110 active:scale-95`}
                >
