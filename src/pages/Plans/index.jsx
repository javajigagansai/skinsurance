          ...
          >
            ...
            <div className="space-y-6 text-left">
              ...
              <div className="pb-4 border-b border-slate-200/50 dark:border-white/5">
                <p className="text-slate-400 text-[10px] uppercase font-bold leading-none">Standard Coverage Value</p>
                <p className="text-navy-950 dark:text-white font-extrabold text-xl mt-1">
                  ${plan.coverageAmount}
                </p>
                <p className="text-slate-400 text-[10px] uppercase font-bold leading-none mt-2">Starting Premium</p>
          ...
          <form onSubmit={handleWizardSubmit} className="space-y-4 pt-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div>
                ...
                <input required type="text" placeholder="Johnathan Doe" className="w-full px-3 py-2 text-xs bg-white dark:bg-navy-900 border border-slate-200 dark:border-white/10 rounded-lg text-navy-950 dark:text-white" />
              </div>
              <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div>
                ...
                <input required type="tel" placeholder="+1 (555) 123-4567" className="w-full px-3 py-2 text-xs bg-white dark:bg-navy-900 border border-slate-200 dark:border-white/10 rounded-lg text-navy-950 dark:text-white" />
              </div>
              <div>
