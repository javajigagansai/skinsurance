    ...
    <section ref={sectionRef} className="w-full min-h-screen flex flex-col justify-center snap-start max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 lg:py-16 border-b border-black/5 dark:border-white/5 bg-transparent transition-colors duration-300">
      ...
      <div className="w-full mb-8 sm:mb-12 text-center">
        <motion.h2
          ...
          className="text-3xl sm:text-4xl md:text-5xl lg:text-[58px] xl:text-[64px] font-extrabold text-red-600 dark:text-red-500 uppercase tracking-[-0.025em] [word-spacing:0.28em] leading-[1.1] font-['Plus_Jakarta_Sans',sans-serif] text-center max-w-5xl mx-auto"
        >
