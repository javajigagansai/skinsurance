      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3 sm:gap-4 mb-4 sm:mb-6">
          <div className="text-left">
            <h2 className="text-2xl sm:text-3xl font-black uppercase tracking-normal text-neutral-950 dark:text-white leading-tight font-['Plus_Jakarta_Sans',sans-serif]">
