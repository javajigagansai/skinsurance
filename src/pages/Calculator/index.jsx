...
export const Calculator = () => {
  ...
  const categories = [
    ...
    { id: 'life', label: 'Life', icon: FaHeartbeat, color: 'text-indigo-500' }, // using heartbeat or same
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="text-center mb-12">
        ...
        <h1 className="text-3xl sm:text-4xl font-bold text-navy-950 dark:text-white mt-2">
          Premium Quote Calculator
        </h1>
        <p className="text-slate-500 dark:text-slate-400 mt-2 max-w-xl mx-auto text-sm">
          Adjust the variables below to evaluate instant custom estimates. Get a policy quote in under 3 minutes.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div>
          <div className="glass-panel dark:glass-panel-gold rounded-3xl p-6 border border-gold-400/20 sticky top-24 text-center overflow-hidden">
            ...
            <h3 className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-4">Estimated Monthly Quote</h3>
            ...
            <div className="my-8 relative inline-block">
              ...
              <div className="w-40 h-40 rounded-full border-4 border-slate-100 dark:border-navy-900 flex flex-col items-center justify-center shadow-lg relative">
                ...
                <span className="text-[10px] text-slate-400 mt-1 uppercase font-semibold">USD / Month</span>
              </div>
            </div>
      ...
      {/* Buy Flow Modal */}
      <Modal isOpen={showBuyModal} onClose={() => setShowBuyModal(false)} title="SK Smart Policy Application Wizard" size="md">
        {successBuy ? (
          <div className="text-center py-8 space-y-4">
            ...
            <h3 className="text-xl font-bold text-navy-950 dark:text-white">Application Approved!</h3>
          ...
          <form onSubmit={handlePurchaseMock} className="space-y-4 pt-2">
            <p className="text-xs text-slate-500 dark:text-slate-400">
              Please finalize details below to secure your <strong>{category.toUpperCase()}</strong> insurance package.
            </p>
            ...
            <div className="p-3 bg-slate-100 dark:bg-navy-900 rounded-xl border border-slate-200/50 dark:border-white/5 space-y-2">
              <p className="text-xs font-bold text-navy-950 dark:text-white">Premium Details Summary</p>
            ...
            <div className="pt-2 flex justify-end space-x-2">
              ...
              <Button type="submit" variant="gold">Process Payout & Activate</Button>
            </div>
          </form>
        )}
      </Modal>
